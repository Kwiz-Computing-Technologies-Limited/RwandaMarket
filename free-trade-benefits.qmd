---
title: "Free Trade Benefits Documentation and Analysis"
---
...
fluidPage(
  h2("Product Origin Declaration Form"),
  product_origin_form
)
```
...
fluidPage(
  h2("Tariff Savings Tracking Form"),
  tariff_savings_form
)
```
...
non_tariff_barrier_form <- fluidPage(
...
fluidPage(
  h2("Non-Tariff Barrier Reporting Form"),
  non_tariff_barrier_form
)
```
