...
layout_column_wrap(
  ...
  !!!lapply(mission_vision, function(item) {
    card(
      ...
      card_header(h4(item$title, style = "color: ;"), style = "background-color: #FFF; text-align: center; border-color: #FFF;"),
...
card(
  style = "border-color: #FFF;",
  card_header(h4(funding_req$title, style = "color: ;"), style = "background-color: #FFF; text-align: center; border-color: #FFF;"),
  card_body(funding_req$content, style = "text-align: center; border-color: #FFF;"),
  full_screen = TRUE
  )
