...
card(
  ...
  layout_column_wrap(
    ...
    !!!lapply(card_content, function(item) {
      card(
        style = "background-color: #FFF; text-align: center; border-color: #7C4700, border-bottom-color: #7C4700;",
        card_header(h4(item$title, style = "color: black;"), style = "background-color: #7C4700; text-align: center; border-color: #FFF;"),
