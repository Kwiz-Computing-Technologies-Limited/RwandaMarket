...
ggplot(impact_data, aes(x = Year)) +
  geom_line(aes(y = Artisans_Supported, color = "Artisans Supported"), size = 1.5) +
  geom_line(aes(y = Jobs_Created, color = "Jobs Created"), size = 1.5) +
  geom_line(aes(y = Trade_Volume_Million * 50, color = "Trade Volume"), size = 1.5) +
  scale_y_continuous(
